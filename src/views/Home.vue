        ...
        <b-container class="mt-4 pt-4">
          <div class="clouds-bg">
            <div style="padding-top: 65px">
              ...
              <vue-typed-js
                ...
                :typeSpeed="100"
              >
                <h3 class="">I'm <span class="typing"></span></h3>
              </vue-typed-js>
            </div>
          </div>
          ...
          <div class="btn-holder mt-1">
            ...
            <b-modal id="modal-1" title="Links for work samples">
              <ul>
                <li>
                  <a href=" https://fastchinagroup.netlify.app/" target="blank"
                    >Fast China Group</a
                  >
                </li>
                <li>
                  <a href="https://fastchinaexpress.netlify.app/" target="blank"
    ...
    <div class="bg-vector mt-4">
      ...
      <!-- <b-container>
        <b-row>
          <b-col>
            <div class="neo p-4">
              <b-row class="about-me d-flex flex-column" style="margin: 50px 0">
                <b-col class="text-center"
                  ><img
                    src="../assets/abbtme.png"
                    alt=""
                    class="img-fluid"
                    height="200"
                    width="400"
                ...
                <b-col class="p-4">
                  <span>
                    My name is Kevin Corpuz. I'm a Front End Engineer based in
                    Philippines. I describe myself as a passionate developer who
                    loves coding, designing and automation. Aside from my job, I
                    like looking at other people's work and that helps me to learn
                    a ton of new stuff, grow as a developer, copy cool things and
                    support other open source projects. I also enjoy gaming and
                    binge watching on Netflix. I used to love traveling to
                    different countries until some Chinese dude started an
                    apocalypse.
                  </span>
                </b-col>
              </b-row>
...
<style>
.bg-vector {
  background-image: url('../assets/wavvv.png');
